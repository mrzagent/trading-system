#!/usr/bin/env python3
"""
backtest_momentum_scalper_binance_fast.py — Momentum Scalper backtest on Binance BTC data
Optimized version using pre-calculated indicators.
"""
import json
import sys
...
def calculate_indicators(df):
    ...
    # Swing high/low (rolling max/min excluding current bar)
...
def run_backtest(candle_limit: int = None):
    print("=" * 70)
    print("MOMENTUM SCALPER — BACKTEST RESULTS (Optimized)")
    print("=" * 70)
    ...
    # Drop NaN rows (first 50+ rows won't have all indicators)
