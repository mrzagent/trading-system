#!/usr/bin/env python3
"""
fetch_binance_5min.py — Download 3+ years of BTC/USDT 5min candles from Binance.

Usage:
    python fetch_binance_5min.py

Stores data in:
    - PostgreSQL: binance_btc_5min table
    - CSV backup: D:\dev\trading\data\binance_btc_5min_YYYY-MM-DD.csv
"""
...
def fetch_all_candles() -> List[Dict[str, Any]]:
    ...
    while current_start < END_TIME:
        ...
        # Update start time for next batch (last candle's open_time + 5 minutes)
        last_open_time = klines[-1][0]
        current_start = last_open_time + (5 * 60 * 1000)  # +5 minutes in ms
...
def save_to_csv(candles: List[Dict[str, Any]]) -> str:
    ...
    filepath = os.path.join(DATA_DIR, f"binance_btc_5min_{timestamp}.csv")
...
def main():
    print("=" * 60)
    print("Binance 5-Minute Historical Data Fetcher")
    print("=" * 60)
    print()
