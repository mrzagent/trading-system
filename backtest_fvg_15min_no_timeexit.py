#!/usr/bin/env python3
"""
backtest_fvg_15min_no_timeexit.py — FVG Strategy: Hold until SL or TP hit
No time exit - trades run until stop loss or take profit is reached.
"""
import sys
...
# Parameter sets to test - no time exit, hold until SL or TP
PARAM_SETS = [
    ...
    {"name": "5.0 SL / 10.0 TP + Confirm", "sl": 5.0, "tp": 10.0, "confirm": True},
    {"name": "3.0 SL / 2.0 TP + Confirm", "sl": 3.0, "tp": 2.0, "confirm": True},
    {"name": "3.0 SL / 5.0 TP + Confirm", "sl": 3.0, "tp": 5.0, "confirm": True},
]
...
def run_backtest():
    print("=" * 70)
    print("FVG 15-MINUTE: HOLD UNTIL SL OR TP (NO TIME EXIT)")
    print("=" * 70)
    print()
    ...
    print("Running parameter sweep (no time exit)...")
    results = []
