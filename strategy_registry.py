...
STRATEGY_MODULES: list[str] = [
    ...
    "strategies.strategy_momentum_scalper",
    "strategies.strategy_pullback_scalper",
    # Function-based strategies with get_metadata()
    "strategies.strategy_rsi",               # STRATEGY = "rsi_mean_reversion"
    "strategies.strategy_momentum",          # STRATEGY = "momentum_rsi"
    "strategies.strategy_fvg",               # STRATEGY = "fvg_proximity"
    "strategies.strategy_volume",            # STRATEGY = "volume_spike"
    "strategies.strategy_trend_breakout",    # STRATEGY = "trend_breakout"
    "strategies.strategy_mean_reversion",    # STRATEGY = "mean_reversion"
    "strategies.strategy_momentum_accel",    # STRATEGY = "momentum_accel"
    "strategies.strategy_vwap_reversion",    # STRATEGY = "vwap_reversion"
]
